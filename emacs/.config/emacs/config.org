...
- [[#general-emacs-settings][General emacs settings]]
  ...
  - [[#dired][Dired]]
  - [[#eldoc][Eldoc]]
  - [[#inject-path-from-shell][Inject PATH from shell]]
  - [[#eww][Eww]]
- [[#evil-mode][Evil mode]]
- [[#ui][UI]]
  - [[#theme][Theme]]
  ...
  - [[#minions-collapsed-minor-modes-in-modeline][Minions (collapsed minor modes in modeline)]]
...
** Minions (collapsed minor modes in modeline)
#+begin_src emacs-lisp
(use-package minions
